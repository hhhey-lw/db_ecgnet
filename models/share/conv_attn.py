...
"""
    code from: https://github.com/ysxGitHub/MVMS-net/blob/main/models/attention.py
"""
...
# =====> Coord Attention [Spatial and channel dimension] <=====
...
# =====> CBAM [Channel Attention => SpatialAttention] <=====
