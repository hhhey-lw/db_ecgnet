...
def resnet1d_wang(input_channels=12, num_classes=9):
    return ResNet1d(BasicBlock1d, [1, 1, 1], input_channels=input_channels, num_classes=num_classes)


"""
    The code comes from: https://github.com/ysxGitHub/MVMS-net
    paper: Time series classification from scratch with deep neural networks: A strong baseline
"""


if __name__ == '__main__':
    x = torch.randn((4, 12, 1000))
    model = resnet1d_wang(num_classes=9)
    out = model(x)
    print(out.shape)
